...
public class Tokens {
        ...
        public static final byte PR = 19;

        public static final byte INVALID_TOKEN = 20;

        public static final Map<Character, TokenInfo> SYMBOLS = Map.of(
        ...
        public static final Map<String, TokenInfo> COMPLEX_SYMBOLS = Map.of(
        ...
        public static final Map<String, TokenInfo> KEYWORDS = Map.of(
